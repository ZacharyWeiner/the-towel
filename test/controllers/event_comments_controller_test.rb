...
class EventCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_comment" do
    assert_difference('EventComment.count') do
      post event_comments_url, params: { event_comment: { cohort_id: @event_comment.cohort_id, comment: @event_comment.comment, event_id: @event_comment.event_id, user_id: @event_comment.user_id } }
    end
  ...
  test "should update event_comment" do
    patch event_comment_url(@event_comment), params: { event_comment: { cohort_id: @event_comment.cohort_id, comment: @event_comment.comment, event_id: @event_comment.event_id, user_id: @event_comment.user_id } }
